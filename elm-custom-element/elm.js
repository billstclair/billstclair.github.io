...
var billstclair$elm_custom_element$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{coordinates: elm$core$Maybe$Nothing, file: elm$core$Maybe$Nothing, selection: elm$core$Maybe$Nothing, selectionEnd: '10', selectionStart: '1', setSelection: 0, text: 'Four score and seven years ago,\nOur forefathers set forth...', triggerCoordinates: 0, triggerSelection: 0, value: 'module Main exposing (main)' + ('\n\n' + ('import Html' + ('\n\n' + 'main = Html.text \"Hello, World!\"')))},
		elm$core$Platform$Cmd$none);
};
var billstclair$elm_custom_element$Main$Noop = {$: 'Noop'};
...
var billstclair$elm_custom_element$Main$focusId = function (id) {
	return A2(
		elm$core$Task$attempt,
		function (_n0) {
			return billstclair$elm_custom_element$Main$Noop;
		},
		elm$browser$Browser$Dom$focus(id));
};
var billstclair$elm_custom_element$Main$textAreaId = 'textarea';
		...
		switch (msg.$) {
			...
			case 'SetSelection':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{setSelection: model.setSelection + 1}),
					billstclair$elm_custom_element$Main$focusId(billstclair$elm_custom_element$Main$textAreaId));
...
var billstclair$elm_custom_element$CustomElement$FileListener$fileId = function (value) {
	return A2(
		elm$html$Html$Attributes$property,
		'fileId',
		elm$json$Json$Encode$string(value));
};
var billstclair$elm_custom_element$CustomElement$FileListener$fileListener = elm$html$Html$node('file-listener');
...
var billstclair$elm_custom_element$CustomElement$FileListener$fileInput = F3(
	function (id, fileAttributes, listenerAttributes) {
		return A2(
			elm$html$Html$span,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_Nil),
					A2(
					billstclair$elm_custom_element$CustomElement$FileListener$fileListener,
					A2(
						elm$core$List$cons,
						billstclair$elm_custom_element$CustomElement$FileListener$fileId(id),
						listenerAttributes),
					_List_Nil)
				]));
	});
var billstclair$elm_custom_element$CustomElement$FileListener$File = F6(
	function (name, lastModified, mimeType, size, data, dataUrl) {
		return {data: data, dataUrl: dataUrl, lastModified: lastModified, mimeType: mimeType, name: name, size: size};
	});
var elm$json$Json$Decode$int = _Json_decodeInt;
var elm$json$Json$Decode$map6 = _Json_map6;
var billstclair$elm_custom_element$CustomElement$FileListener$fileDecoder = A7(
	elm$json$Json$Decode$map6,
	billstclair$elm_custom_element$CustomElement$FileListener$File,
...
var billstclair$elm_custom_element$CustomElement$FileListener$onLoad = function (tagger) {
	return A2(
		elm$html$Html$Events$on,
		'load',
		A2(
...
var billstclair$elm_custom_element$CustomElement$TextAreaTracker$encodeSetSelection = F3(
...
var billstclair$elm_custom_element$CustomElement$TextAreaTracker$setSelection = F3(
	function (start, end, count) {
		return A2(
			elm$html$Html$Attributes$property,
			'setSelection',
			A3(billstclair$elm_custom_element$CustomElement$TextAreaTracker$encodeSetSelection, start, end, count));
	});
...
var billstclair$elm_custom_element$Main$SetEnd = function (a) {
	return {$: 'SetEnd', a: a};
};
var billstclair$elm_custom_element$Main$SetFile = function (a) {
	return {$: 'SetFile', a: a};
};
var billstclair$elm_custom_element$Main$SetSelection = {$: 'SetSelection'};
var billstclair$elm_custom_element$Main$SetStart = function (a) {
	return {$: 'SetStart', a: a};
};
...
var billstclair$elm_custom_element$Main$b = function (string) {
	return A2(
		elm$html$Html$b,
		_List_Nil,
		_List_fromArray(
...
var billstclair$elm_custom_element$Main$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('CustomElement Example')
					])),
				A2(
				elm$html$Html$p,
				_List_Nil,
				...
				_List_fromArray(
					[
						...
						billstclair$elm_custom_element$Main$br,
						elm$html$Html$text('Or change \'Start\' and \'End\' and click \'Set Selection\'.')
					])),
				A2(
				elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$id(billstclair$elm_custom_element$Main$textAreaId),
							...
							[
								...
								_List_fromArray(
									[
										...
										elm$html$Html$Events$onInput(billstclair$elm_custom_element$Main$SetStart),
										elm$html$Html$Attributes$value(model.selectionStart)
									]),
								_List_Nil),
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$type_('text'),
										elm$html$Html$Attributes$size(3),
										elm$html$Html$Events$onInput(billstclair$elm_custom_element$Main$SetEnd),
										elm$html$Html$Attributes$value(model.selectionEnd)
									]),
								_List_Nil),
								elm$html$Html$text(' '),
								A2(
								...
								_List_fromArray(
									[
										elm$html$Html$Events$onClick(billstclair$elm_custom_element$Main$SetSelection)
									]),
								_List_fromArray(
									[
										elm$html$Html$text('Set Selection')
									])),
								billstclair$elm_custom_element$Main$br,
								A2(
								elm$html$Html$button,
						...
						var start = A2(
							...
							0,
							elm$core$String$toInt(model.selectionStart));
						var end = A2(
							elm$core$Maybe$withDefault,
							0,
							elm$core$String$toInt(model.selectionEnd));
						var count = model.setSelection;
						return A2(
							billstclair$elm_custom_element$CustomElement$TextAreaTracker$textAreaTracker,
							_List_fromArray(
								[
									billstclair$elm_custom_element$CustomElement$TextAreaTracker$textAreaId(billstclair$elm_custom_element$Main$textAreaId),
									A3(billstclair$elm_custom_element$CustomElement$TextAreaTracker$setSelection, start, end, count),
				...
				_List_fromArray(
					[
						elm$html$Html$text('file-listener Custom Element')
					])),
				A2(
				elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Click the \'Choose File\' button and choose an image file.'),
						elm$html$Html$text(' Information about the file and the image will appear.')
					])),
				A2(
				elm$html$Html$div,
				_List_Nil,
					...
					[
						...
						if (_n0.$ === 'Nothing') {
							...
							return A2(
								...
								_List_fromArray(
									[
										billstclair$elm_custom_element$Main$b('Name: '),
										elm$html$Html$text(file.name),
										billstclair$elm_custom_element$Main$br,
										billstclair$elm_custom_element$Main$b('Last Modified: '),
										elm$html$Html$text(
										rtfeldman$elm_iso8601_date_strings$Iso8601$fromTime(
											elm$time$Time$millisToPosix(file.lastModified))),
										billstclair$elm_custom_element$Main$br,
										billstclair$elm_custom_element$Main$b('Mime Type: '),
										elm$html$Html$text(file.mimeType),
										billstclair$elm_custom_element$Main$br,
										billstclair$elm_custom_element$Main$b('Size: '),
										elm$html$Html$text(
										elm$core$String$fromInt(file.size)),
										billstclair$elm_custom_element$Main$br,
										A2(
										elm$html$Html$img,
										_List_fromArray(
											[
												elm$html$Html$Attributes$src(file.dataUrl),
				...
				_List_fromArray(
					[
						elm$html$Html$text('code-editor Custom Element')
					])),
				A2(
				elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Edit the text below.'),
						elm$html$Html$text(' Notice that your edits appear in the area below that.')
					])),
				A2(
				billstclair$elm_custom_element$CustomElement$CodeEditor$codeEditor,
				_List_fromArray(
					[
						billstclair$elm_custom_element$CustomElement$CodeEditor$editorValue(model.value),
						billstclair$elm_custom_element$CustomElement$CodeEditor$onEditorChanged(billstclair$elm_custom_element$Main$CodeChanged)
					]),
				_List_Nil),
				A2(
				elm$html$Html$p,
				...
				_List_fromArray(
					[
						elm$html$Html$text('Text above echoed below:')
					])),
				A2(
				elm$html$Html$pre,
				_List_Nil,
				...
				_List_fromArray(
					[
						elm$html$Html$text(billstclair$elm_custom_element$Main$copyright + ' 2018 '),
						A2(
						elm$html$Html$a,
						_List_fromArray(
							[
								elm$html$Html$Attributes$href('https://lisplog.org/')
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$href('https://github.com/billstclair/elm-custom-element')
							]),
						_List_fromArray(
							[
								elm$html$Html$text('github.com/billstclair/elm-custom-element')
							]))
					]))
			]));
};
...
var billstclair$elm_custom_element$Main$main = elm$browser$Browser$element(
	{
		init: billstclair$elm_custom_element$Main$init,
		subscriptions: function (_n0) {
			return elm$core$Platform$Sub$none;
		},
		update: billstclair$elm_custom_element$Main$update,
		view: billstclair$elm_custom_element$Main$view
	});
_Platform_export({'Main':{'init':billstclair$elm_custom_element$Main$main(
