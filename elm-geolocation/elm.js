...
var author$project$PortFunnel$Geolocation$State = function (a) {
	return {$: 'State', a: a};
};
var elm$core$Basics$identity = function (x) {
	return x;
};
var author$project$PortFunnel$Geolocation$initialState = author$project$PortFunnel$Geolocation$State(
	{isLoaded: false});
	...
	return Janiczek$cmd_extra$Cmd$Extra$withNoCmd(
		{
			...
			state: {geolocation: author$project$PortFunnel$Geolocation$initialState},
			useSimulator: true,
			wasLoaded: false,
			watching: false
		});
...
var author$project$PortFunnel$Geolocation$SendChanges = {$: 'SendChanges'};
var author$project$PortFunnel$Geolocation$Startup = {$: 'Startup'};
var author$project$PortFunnel$Geolocation$StopChanges = {$: 'StopChanges'};
var elm$json$Json$Decode$decodeValue = _Json_run;
var author$project$PortFunnel$Geolocation$decodeValue = F2(
...
var author$project$PortFunnel$Geolocation$GetLocation = function (a) {
	return {$: 'GetLocation', a: a};
};
var author$project$PortFunnel$Geolocation$Options = F3(
...
var author$project$PortFunnel$Geolocation$optionsDecoder = A4(
	elm$json$Json$Decode$map3,
	author$project$PortFunnel$Geolocation$Options,
	...
	A2(
		...
		'maximumAge',
		elm$json$Json$Decode$nullable(elm$json$Json$Decode$int)));
var author$project$PortFunnel$Geolocation$getLocationDecoder = A2(elm$json$Json$Decode$map, author$project$PortFunnel$Geolocation$GetLocation, author$project$PortFunnel$Geolocation$optionsDecoder);
var author$project$PortFunnel$Geolocation$ReturnedError = function (a) {
	return {$: 'ReturnedError', a: a};
};
var author$project$PortFunnel$Geolocation$LocationUnavailable = function (a) {
	return {$: 'LocationUnavailable', a: a};
};
var author$project$PortFunnel$Geolocation$PermissionDenied = function (a) {
	return {$: 'PermissionDenied', a: a};
};
var author$project$PortFunnel$Geolocation$Timeout = function (a) {
	return {$: 'Timeout', a: a};
};
var elm$json$Json$Decode$string = _Json_decodeString;
var author$project$PortFunnel$Geolocation$errorDecoder = elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
			A2(
			elm$json$Json$Decode$map,
			author$project$PortFunnel$Geolocation$PermissionDenied,
			A2(elm$json$Json$Decode$field, 'PermissionDenied', elm$json$Json$Decode$string)),
			A2(
			elm$json$Json$Decode$map,
			author$project$PortFunnel$Geolocation$LocationUnavailable,
			A2(elm$json$Json$Decode$field, 'LocationUnavailable', elm$json$Json$Decode$string)),
			A2(
			elm$json$Json$Decode$map,
			author$project$PortFunnel$Geolocation$Timeout,
			A2(elm$json$Json$Decode$field, 'Timeout', elm$json$Json$Decode$string))
		]));
var author$project$PortFunnel$Geolocation$returnedErrorDecoder = A2(elm$json$Json$Decode$map, author$project$PortFunnel$Geolocation$ReturnedError, author$project$PortFunnel$Geolocation$errorDecoder);
var author$project$PortFunnel$Geolocation$ReturnedLocation = function (a) {
	return {$: 'ReturnedLocation', a: a};
};
var author$project$PortFunnel$Geolocation$Location = F6(
...
var author$project$PortFunnel$Geolocation$Altitude = F2(
	function (value, accuracy) {
		return {accuracy: accuracy, value: value};
	});
var elm$json$Json$Decode$float = _Json_decodeFloat;
var elm$json$Json$Decode$map2 = _Json_map2;
var author$project$PortFunnel$Geolocation$altitudeDecoder = A3(
	elm$json$Json$Decode$map2,
	author$project$PortFunnel$Geolocation$Altitude,
...
var author$project$PortFunnel$Geolocation$Moving = function (a) {
	return {$: 'Moving', a: a};
};
var author$project$PortFunnel$Geolocation$Static = {$: 'Static'};
var elm$json$Json$Decode$andThen = _Json_andThen;
var elm$json$Json$Decode$fail = _Json_fail;
var elm$json$Json$Decode$succeed = _Json_succeed;
var author$project$PortFunnel$Geolocation$movementDecoder = elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
			A2(
			elm$json$Json$Decode$andThen,
			function (s) {
				return (s === 'static') ? elm$json$Json$Decode$succeed(author$project$PortFunnel$Geolocation$Static) : elm$json$Json$Decode$fail('String not \"static\"');
			},
			...
			F2(
				function (speed, degreesFromNorth) {
					return author$project$PortFunnel$Geolocation$Moving(
...
var author$project$PortFunnel$Geolocation$locationDecoder = A7(
	elm$json$Json$Decode$map6,
	author$project$PortFunnel$Geolocation$Location,
	...
	A2(
		elm$json$Json$Decode$field,
		'altitude',
		elm$json$Json$Decode$nullable(author$project$PortFunnel$Geolocation$altitudeDecoder)),
	A2(
		elm$json$Json$Decode$field,
		'movement',
		elm$json$Json$Decode$nullable(author$project$PortFunnel$Geolocation$movementDecoder)),
	A2(
		elm$json$Json$Decode$map,
		elm$time$Time$millisToPosix,
		A2(elm$json$Json$Decode$field, 'timestamp', elm$json$Json$Decode$int)));
var author$project$PortFunnel$Geolocation$returnedLocationDecoder = A2(elm$json$Json$Decode$map, author$project$PortFunnel$Geolocation$ReturnedLocation, author$project$PortFunnel$Geolocation$locationDecoder);
var author$project$PortFunnel$Geolocation$decode = function (_n0) {
	var tag = _n0.tag;
	var args = _n0.args;
	switch (tag) {
		case 'getlocation':
			return A2(author$project$PortFunnel$Geolocation$decodeValue, author$project$PortFunnel$Geolocation$getLocationDecoder, args);
		case 'sendchanges':
			return elm$core$Result$Ok(author$project$PortFunnel$Geolocation$SendChanges);
		case 'stopchanges':
			return elm$core$Result$Ok(author$project$PortFunnel$Geolocation$StopChanges);
		case 'location':
			return A2(author$project$PortFunnel$Geolocation$decodeValue, author$project$PortFunnel$Geolocation$returnedLocationDecoder, args);
		case 'error':
			return A2(author$project$PortFunnel$Geolocation$decodeValue, author$project$PortFunnel$Geolocation$returnedErrorDecoder, args);
		case 'startup':
			return elm$core$Result$Ok(author$project$PortFunnel$Geolocation$Startup);
		default:
...
var author$project$PortFunnel$Geolocation$errorEncoder = function (error) {
	switch (error.$) {
...
var author$project$PortFunnel$Geolocation$altitudeEncoder = function (altitude) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var author$project$PortFunnel$Geolocation$movementEncoder = function (movement) {
	if (movement.$ === 'Static') {
...
var author$project$PortFunnel$Geolocation$locationEncoder = function (location) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				...
				'altitude',
				function () {
					var _n0 = location.altitude;
					if (_n0.$ === 'Nothing') {
						return elm$json$Json$Encode$null;
					} else {
						var alt = _n0.a;
						return author$project$PortFunnel$Geolocation$altitudeEncoder(alt);
					}
				}()),
				_Utils_Tuple2(
				'movement',
				function () {
					var _n1 = location.movement;
					if (_n1.$ === 'Nothing') {
						return elm$json$Json$Encode$null;
					} else {
						var move = _n1.a;
						return author$project$PortFunnel$Geolocation$movementEncoder(move);
					}
				}()),
				_Utils_Tuple2(
				'timestamp',
...
var author$project$PortFunnel$Geolocation$moduleName = 'Geolocation';
var elm$json$Json$Encode$bool = _Json_wrap;
var author$project$PortFunnel$Geolocation$optionsEncoder = function (options) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var author$project$PortFunnel$Geolocation$encode = function (message) {
	switch (message.$) {
		case 'GetLocation':
			var options = message.a;
			return A3(
				billstclair$elm_port_funnel$PortFunnel$GenericMessage,
				author$project$PortFunnel$Geolocation$moduleName,
				'getlocation',
				author$project$PortFunnel$Geolocation$optionsEncoder(options));
		case 'SendChanges':
			return A3(billstclair$elm_port_funnel$PortFunnel$GenericMessage, author$project$PortFunnel$Geolocation$moduleName, 'sendchanges', elm$json$Json$Encode$null);
		case 'StopChanges':
			return A3(billstclair$elm_port_funnel$PortFunnel$GenericMessage, author$project$PortFunnel$Geolocation$moduleName, 'stopchanges', elm$json$Json$Encode$null);
		case 'ReturnedLocation':
			...
			return A3(
				...
				author$project$PortFunnel$Geolocation$moduleName,
				'location',
				author$project$PortFunnel$Geolocation$locationEncoder(location));
		case 'ReturnedError':
			var error = message.a;
			return A3(
				billstclair$elm_port_funnel$PortFunnel$GenericMessage,
				author$project$PortFunnel$Geolocation$moduleName,
				'error',
				author$project$PortFunnel$Geolocation$errorEncoder(error));
		default:
			return A3(billstclair$elm_port_funnel$PortFunnel$GenericMessage, author$project$PortFunnel$Geolocation$moduleName, 'startup', elm$json$Json$Encode$null);
	}
};
var author$project$PortFunnel$Geolocation$ErrorResponse = function (a) {
	return {$: 'ErrorResponse', a: a};
};
var author$project$PortFunnel$Geolocation$LocationResponse = function (a) {
	return {$: 'LocationResponse', a: a};
};
var author$project$PortFunnel$Geolocation$NoResponse = {$: 'NoResponse'};
var author$project$PortFunnel$Geolocation$process = F2(
	function (message, unboxed) {
		var state = unboxed.a;
		switch (message.$) {
			case 'Startup':
				return _Utils_Tuple2(
					author$project$PortFunnel$Geolocation$State(
						_Utils_update(
							state,
							{isLoaded: true})),
					author$project$PortFunnel$Geolocation$NoResponse);
			case 'ReturnedLocation':
				var location = message.a;
				return _Utils_Tuple2(
					unboxed,
					author$project$PortFunnel$Geolocation$LocationResponse(location));
			case 'ReturnedError':
				var location = message.a;
				return _Utils_Tuple2(
					unboxed,
					author$project$PortFunnel$Geolocation$ErrorResponse(location));
			default:
				return _Utils_Tuple2(unboxed, author$project$PortFunnel$Geolocation$NoResponse);
		}
	});
...
var author$project$PortFunnel$Geolocation$makeSimulatedCmdPort = A2(billstclair$elm_port_funnel$PortFunnel$makeSimulatedFunnelCmdPort, author$project$PortFunnel$Geolocation$moduleDesc, author$project$PortFunnel$Geolocation$simulator);
var author$project$Main$simulatedCmdPort = author$project$PortFunnel$Geolocation$makeSimulatedCmdPort(author$project$Main$Process);
...
var author$project$Main$appTrampoline = F4(
	function (genericMessage, funnel, state, model) {
		...
		return A5(billstclair$elm_port_funnel$PortFunnel$appProcess, theCmdPort, genericMessage, geolocationFunnel, state, model);
	});
...
var author$project$PortFunnel$Geolocation$isLoaded = function (_n0) {
	var state = _n0.a;
	return state.isLoaded;
};
var elm$core$Basics$not = _Basics_not;
var author$project$Main$doIsLoaded = function (model) {
	return ((!model.wasLoaded) && author$project$PortFunnel$Geolocation$isLoaded(model.state.geolocation)) ? _Utils_update(
		model,
		{useSimulator: false, wasLoaded: true}) : model;
};
var author$project$PortFunnel$Geolocation$errorToString = function (error) {
	switch (error.$) {
		case 'PermissionDenied':
			var string = error.a;
					...
					_Utils_update(
						model,
						{
							error: elm$core$Maybe$Just(
								author$project$PortFunnel$Geolocation$errorToString(error))
						}));
			default:
				return Janiczek$cmd_extra$Cmd$Extra$withNoCmd(model);
		}
	});
var author$project$PortFunnel$Geolocation$commander = F2(
	function (_n0, _n1) {
		return elm$core$Platform$Cmd$none;
	});
	...
	_List_fromArray(
		[
			...
			author$project$Main$GeolocationFunnel(
				A4(billstclair$elm_port_funnel$PortFunnel$FunnelSpec, author$project$Main$geolocationAccessors, author$project$PortFunnel$Geolocation$moduleDesc, author$project$PortFunnel$Geolocation$commander, author$project$Main$geolocationHandler)))
		]));
...
var author$project$PortFunnel$Geolocation$send = billstclair$elm_port_funnel$PortFunnel$sendMessage(author$project$PortFunnel$Geolocation$moduleDesc);
var author$project$Main$send = F2(
	function (message, model) {
		return A2(
			author$project$PortFunnel$Geolocation$send,
...
var author$project$PortFunnel$Geolocation$watchChanges = author$project$PortFunnel$Geolocation$SendChanges;
		...
		switch (msg.$) {
			case 'GetLocation':
				return A2(
					...
					A2(author$project$Main$send, author$project$PortFunnel$Geolocation$now, model),
					model);
			case 'ToggleWatch':
				return A2(
					Janiczek$cmd_extra$Cmd$Extra$withCmd,
					A2(
						...
						model.watching ? author$project$PortFunnel$Geolocation$stopWatching : author$project$PortFunnel$Geolocation$watchChanges,
						model),
					_Utils_update(
						model,
...
var author$project$Main$GetLocation = {$: 'GetLocation'};
var author$project$Main$ToggleWatch = {$: 'ToggleWatch'};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Geolocation Example')
					])),
				function () {
				var _n0 = model.error;
				if (_n0.$ === 'Nothing') {
				...
				_List_fromArray(
					[
						author$project$Main$b('Simulator: '),
						elm$html$Html$text(
						model.useSimulator ? 'yes' : 'no')
					])),
				function () {
				var _n1 = model.location;
				if (_n1.$ === 'Nothing') {
					return elm$html$Html$text('');
				} else {
					var location = _n1.a;
					return A2(
						...
						_List_fromArray(
							[
								author$project$Main$b('Count: '),
								elm$html$Html$text(
								elm$core$String$fromInt(model.count)),
								author$project$Main$br,
								author$project$Main$b('Latitude: '),
								elm$html$Html$text(
								elm$core$String$fromFloat(location.latitude)),
								author$project$Main$br,
								author$project$Main$b('Longitude: '),
								elm$html$Html$text(
								elm$core$String$fromFloat(location.longitude)),
								author$project$Main$br,
								author$project$Main$b('Accuracy: '),
								elm$html$Html$text(
								elm$core$String$fromFloat(location.accuracy)),
								function () {
								var _n2 = location.altitude;
								if (_n2.$ === 'Nothing') {
									return elm$html$Html$text('');
								} else {
									var altitude = _n2.a;
									return A2(
										...
										_List_fromArray(
											[
												author$project$Main$br,
												author$project$Main$b('Altitude: '),
												elm$html$Html$text(
												elm$core$String$fromFloat(altitude.value)),
												elm$html$Html$text(', accuracy: '),
												elm$html$Html$text(
												elm$core$String$fromFloat(altitude.accuracy))
											]));
								}
							}(),
								function () {
								var _n3 = location.movement;
								if (_n3.$ === 'Nothing') {
									return elm$html$Html$text('');
								} else {
									var movement = _n3.a;
									return A2(
										...
										_List_fromArray(
											[
												author$project$Main$br,
												author$project$Main$b('Movement: '),
												function () {
												if (movement.$ === 'Static') {
													return elm$html$Html$text('static');
												} else {
													var speed = movement.a.speed;
													var degreesFromNorth = movement.a.degreesFromNorth;
													return A2(
														...
														_List_fromArray(
															[
																...
																elm$html$Html$text(
																elm$core$String$fromFloat(speed)),
																elm$html$Html$text(' heading: '),
																elm$html$Html$text(
																elm$core$String$fromFloat(degreesFromNorth))
															]));
												}
											}()
											]));
								...
								author$project$Main$br,
								author$project$Main$b('Timestamp: '),
								elm$html$Html$text(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('This is an example of the '),
								A2(
								elm$html$Html$a,
								_List_fromArray(
									[
										elm$html$Html$Attributes$href('http://package.elm-lang.org/packages/billstclair/elm-geolocation/latest')
									]),
								_List_fromArray(
									[
										elm$html$Html$text('billstclair/elm-geolocation')
									])),
								elm$html$Html$text(' Elm package.')
							])),
						A2(
						elm$html$Html$span,
						_List_Nil,
						_List_fromArray(
							[
								elm$html$Html$text('Press the \'Get\' button to get the location now.'),
								author$project$Main$br,
								elm$html$Html$text('Press the \'Watch\' button to report changes in location.'),
								author$project$Main$br,
								elm$html$Html$text('Press the \'Unwatch\' button to stop reporting changes.')
							])),
						A2(
						elm$html$Html$a,
						_List_fromArray(
							[
								elm$html$Html$Attributes$href('https://github.com/billstclair/elm-geolocation')
							]),
						_List_fromArray(
							[
								elm$html$Html$text('Source at GitHub')
							]))
					]))
			]));
};
