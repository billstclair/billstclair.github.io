...
var author$project$Main$BothTable = {$: 'BothTable'};
var author$project$Main$Boy = {$: 'Boy'};
var author$project$Main$Girl = {$: 'Girl'};
var author$project$Main$ReceiveNames = F2(
	function (a, b) {
		return {$: 'ReceiveNames', a: a, b: b};
	});
var author$project$Main$namesDir = 'names/';
var author$project$Main$boyNamesFile = author$project$Main$namesDir + 'boy-names.json';
var author$project$Main$emptyNames = {boys: _List_Nil, girls: _List_Nil};
...
var author$project$IdSearch$makeTable = F2(
	function (dictCount, getIdentifiers) {
		var cnt = A2(elm$core$Basics$max, dictCount, 1);
		return {
			dictCount: cnt,
			dicts: A2(
				elm$core$List$map,
				...
				A2(elm$core$List$range, 1, cnt)),
			getIdentifiers: getIdentifiers
		};
	});
var author$project$Main$dictCount = 3;
...
var author$project$Main$makeTable = A2(
	author$project$IdSearch$makeTable,
	author$project$Main$dictCount,
	A2(elm$core$Basics$composeR, elm$core$String$toLower, elm$core$List$singleton));
var author$project$Main$emptyTables = {both: author$project$Main$makeTable, boys: author$project$Main$makeTable, girls: author$project$Main$makeTable};
var elm$json$Json$Decode$field = _Json_decodeField;
var elm$json$Json$Decode$list = _Json_decodeList;
var elm$json$Json$Decode$string = _Json_decodeString;
var author$project$Main$decodeNames = A2(
...
var author$project$Main$getNameFile = F2(
	function (file, tagger) {
		return elm$http$Http$get(
			{
				expect: A2(elm$http$Http$expectJson, tagger, author$project$Main$decodeNames),
				url: file
			});
	});
var author$project$Main$girlNamesFile = author$project$Main$namesDir + 'girl-names.json';
	...
	function (_n0, url, key) {
		return A2(
			...
			_List_fromArray(
				[
					A2(
					author$project$Main$getNameFile,
					author$project$Main$boyNamesFile,
					author$project$Main$ReceiveNames(author$project$Main$Boy)),
					A2(
					author$project$Main$getNameFile,
					author$project$Main$girlNamesFile,
					author$project$Main$ReceiveNames(author$project$Main$Girl))
				]),
			{complete: '', completeWhich: author$project$Main$BothTable, completions: _List_Nil, error: elm$core$Maybe$Nothing, names: author$project$Main$emptyNames, receivedOne: false, selection: elm$core$Maybe$Nothing, tables: author$project$Main$emptyTables, text: 'I love my @Angel', triggerSelection: 0});
	});
...
var author$project$IdSearch$lookup = F2(
	function (string, table) {
		var len = elm$core$String$length(string);
		var dictCount = table.dictCount;
		var _n0 = (_Utils_cmp(dictCount, len) < 0) ? _Utils_Tuple2(
			dictCount - 1,
			A2(elm$core$String$left, dictCount, string)) : _Utils_Tuple2(len - 1, string);
		var idx = _n0.a;
		var key = _n0.b;
		var dict = A2(
			elm$core$Maybe$withDefault,
			elm$core$Dict$empty,
			A2(elm_community$list_extra$List$Extra$getAt, idx, table.dicts));
		var _n1 = A2(elm$core$Dict$get, key, dict);
		if (_n1.$ === 'Nothing') {
			return _List_Nil;
		} else {
			var hits = _n1.a;
			return _Utils_eq(dictCount, len) ? hits : A2(
				elm$core$List$filter,
				function (hit) {
					var ids = table.getIdentifiers(hit);
					var _n2 = A2(
						elm_community$list_extra$List$Extra$find,
						function (id) {
							return A2(elm$core$String$contains, string, id);
						},
						ids);
					if (_n2.$ === 'Nothing') {
						return false;
...
var author$project$Main$findAtName = F2(
	function (cursor, string) {
		var beginning = A3(
			...
			elm$core$String$toLower(
				A2(elm$core$String$left, cursor, string)));
		if (A2(elm$core$String$startsWith, '@', beginning) && (!A2(elm$core$String$contains, ' ', beginning))) {
			return elm$core$Maybe$Just(
				A2(elm$core$String$dropLeft, 1, beginning));
		} else {
			var res = A2(elm_community$string_extra$String$Extra$rightOfBack, ' @', beginning);
			return ((res !== '') && (!A2(elm$core$String$contains, ' ', res))) ? elm$core$Maybe$Just(res) : elm$core$Maybe$Nothing;
		}
	});
var author$project$Main$getTable = F2(
	function (which, tables) {
		switch (which.$) {
			case 'BoyTable':
				return tables.boys;
			case 'GirlTable':
...
var author$project$Main$sortNames = F2(
	function (prefix, names) {
		var tuples = A2(
			elm$core$List$map,
			function (name) {
				return _Utils_Tuple2(
					A2(elm$core$String$startsWith, prefix, name) ? 0 : 1,
					name);
			},
			names);
		return A2(
			...
			elm$core$List$sort(tuples));
	});
var author$project$Main$onSelection = F2(
	function (selection, mdl) {
		var model = _Utils_update(
			mdl,
			{complete: '', completions: _List_Nil, selection: elm$core$Maybe$Nothing});
		var cursor = selection.selectionEnd;
		if (!_Utils_eq(cursor, selection.selectionStart)) {
			return Janiczek$cmd_extra$Cmd$Extra$withNoCmd(model);
		} else {
			var _n0 = A2(author$project$Main$findAtName, cursor, model.text);
			if (_n0.$ === 'Nothing') {
				return Janiczek$cmd_extra$Cmd$Extra$withNoCmd(model);
			} else {
				var complete = _n0.a;
				var table = A2(author$project$Main$getTable, model.completeWhich, model.tables);
				var completions = A2(
					author$project$Main$sortNames,
					complete,
					A2(author$project$IdSearch$lookup, complete, table));
...
var author$project$IdSearch$findSubstrings = F2(
	function (length, string) {
		if (!length) {
			return _List_Nil;
		} else {
			if (length === 1) {
				return (elm$core$String$length(string) > 0) ? _List_fromArray(
					[
						A2(elm$core$String$left, 1, string)
					]) : _List_Nil;
			} else {
				var maxidx = elm$core$String$length(string) - length;
				var loop = F3(
					function (idx, tail, res) {
						loop:
						while (true) {
							if (_Utils_cmp(idx, maxidx) > 0) {
								return elm$core$List$reverse(res);
							} else {
								var substr = A2(elm$core$String$left, length, tail);
								var $temp$idx = idx + 1,
									$temp$tail = A2(elm$core$String$dropLeft, 1, tail),
									$temp$res = (A2(elm$core$String$contains, ' ', substr) || A2(elm$core$List$member, substr, res)) ? res : A2(
									elm$core$List$cons,
									A2(elm$core$String$left, length, tail),
									res);
								idx = $temp$idx;
								tail = $temp$tail;
								res = $temp$res;
				...
				return A3(loop, 0, string, _List_Nil);
			}
		}
	});
...
var author$project$IdSearch$insert = F2(
	function (a, table) {
		var identifiers = table.getIdentifiers(a);
		var dictInsert = F2(
			function (substr, d) {
				var elts = A2(
					elm$core$Maybe$withDefault,
					_List_Nil,
					A2(elm$core$Dict$get, substr, d));
				return A2(elm$core$List$member, a, elts) ? d : A3(
					elm$core$Dict$insert,
					substr,
					A2(elm$core$List$cons, a, elts),
					d);
			});
		var loop = F3(
			function (idx, dicts, res) {
				loop:
				while (true) {
					if (!dicts.b) {
						return elm$core$List$reverse(res);
						...
						var dict = dicts.a;
						var moreDicts = dicts.b;
						var substrs = elm$core$List$concat(
							A2(
								elm$core$List$map,
								author$project$IdSearch$findSubstrings(idx),
								identifiers));
						var newDict = A3(elm$core$List$foldl, dictInsert, dict, substrs);
						var $temp$idx = idx + 1,
							$temp$dicts = moreDicts,
							$temp$res = A2(elm$core$List$cons, newDict, res);
						idx = $temp$idx;
						dicts = $temp$dicts;
						res = $temp$res;
						continue loop;
		...
		return _Utils_update(
			table,
			{
				dicts: A3(loop, 1, table.dicts, _List_Nil)
			});
	});
var author$project$IdSearch$insertList = F2(
	function (list, table) {
		return A3(elm$core$List$foldl, author$project$IdSearch$insert, table, list);
	});
var author$project$Main$boygirlToString = function (boygirl) {
	if (boygirl.$ === 'Boy') {
		return 'boy';
	} else {
		return 'girl';
...
var author$project$Main$TextChanged = function (a) {
...
var author$project$Main$doCompletion = function (model) {
	return A2(
		elm$core$Task$perform,
		author$project$Main$TextChanged,
		elm$core$Task$succeed(model.text));
};
var author$project$Main$setNames = F3(
	function (boygirl, nameList, names) {
		if (boygirl.$ === 'Boy') {
			return _Utils_update(
				names,
				{boys: nameList});
...
var author$project$Main$setTable = F3(
	function (which, table, tables) {
		switch (which.$) {
			case 'BoyTable':
				return _Utils_update(
					tables,
...
var author$project$Main$BoyTable = {$: 'BoyTable'};
var author$project$Main$GirlTable = {$: 'GirlTable'};
var author$project$Main$whichTable = function (boygirl) {
	if (boygirl.$ === 'Boy') {
		return author$project$Main$BoyTable;
	} else {
		return author$project$Main$GirlTable;
	}
};
var elm$core$Debug$log = _Debug_log;
var author$project$Main$receiveNames = F3(
	function (boygirl, result, model) {
		if (result.$ === 'Ok') {
			var namelist = result.a;
			var which = author$project$Main$whichTable(boygirl);
			var tables = model.tables;
			var newTable = A2(
				author$project$IdSearch$insertList,
				namelist,
				A2(author$project$Main$getTable, which, tables));
			var newBoth = A2(
				author$project$IdSearch$insertList,
				namelist,
				A2(author$project$Main$getTable, author$project$Main$BothTable, tables));
			return A2(
				Janiczek$cmd_extra$Cmd$Extra$withCmds,
				_List_fromArray(
					[
						model.receivedOne ? author$project$Main$doCompletion(model) : elm$core$Platform$Cmd$none
					]),
				_Utils_update(
					model,
					{
						names: A3(author$project$Main$setNames, boygirl, namelist, model.names),
						receivedOne: true,
						tables: A3(
							author$project$Main$setTable,
							author$project$Main$BothTable,
							newBoth,
							A3(author$project$Main$setTable, which, newTable, tables))
					}));
		} else {
			var error = result.a;
			var err = A2(
				elm$core$Debug$log,
				'Error reading ' + (author$project$Main$boygirlToString(boygirl) + ' names: '),
				error);
			return Janiczek$cmd_extra$Cmd$Extra$withNoCmd(
				_Utils_update(
					model,
...
var author$project$Main$textChanged = F2(
	function (text, model) {
		return Janiczek$cmd_extra$Cmd$Extra$withNoCmd(
			_Utils_update(
				model,
				{
					text: text,
					triggerSelection: A2(elm$core$String$contains, '@', text) ? (model.triggerSelection + 1) : model.triggerSelection
				}));
	});
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'ReceiveNames':
				var boygirl = msg.a;
				var result = msg.b;
				return A3(author$project$Main$receiveNames, boygirl, result, model);
			case 'ChooseTable':
				var completeWhich = msg.a;
				return A2(
					author$project$Main$textChanged,
					model.text,
					_Utils_update(
						model,
						{completeWhich: completeWhich}));
			case 'OnSelection':
				var selection = msg.a;
				return A2(author$project$Main$onSelection, selection, model);
			default:
				var text = msg.a;
				return A2(author$project$Main$textChanged, text, model);
		}
	});
var author$project$Main$OnSelection = function (a) {
	return {$: 'OnSelection', a: a};
};
var author$project$Main$ChooseTable = function (a) {
	return {$: 'ChooseTable', a: a};
};
...
var author$project$Main$fontSize = function (scale) {
	return mdgriffith$elm_ui$Element$Font$size(
		elm$core$Basics$round(
			author$project$Main$scaled(scale)));
};
...
var author$project$Main$idAttribute = function (id) {
	return mdgriffith$elm_ui$Element$htmlAttribute(
		elm$html$Html$Attributes$id(id));
};
var author$project$Main$packageUrl = 'http://package.elm-lang.org/packages/billstclair/elm-id-search/latest';
var author$project$Main$pad = 10;
var author$project$Main$pageTitle = 'billstclair/elm-id-search Example';
var author$project$Main$stringListToString = function (list) {
	return A2(
...
var author$project$Main$textAreaId = 'textarea';
...
var author$project$Main$mainPage = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$spacing(author$project$Main$pad),
				mdgriffith$elm_ui$Element$padding(author$project$Main$pad),
				author$project$Main$fontSize(2)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						author$project$Main$fontSize(3),
						mdgriffith$elm_ui$Element$Font$bold
					]),
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$text(author$project$Main$pageTitle)
					])),
				A2(
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$text('Type some text below.' + ' Names beginning with \"@\" will show completions.')
					])),
				A2(
				mdgriffith$elm_ui$Element$row,
				_List_Nil,
					...
					[
							...
							]),
						{
							label: A2(
								...
								_List_Nil,
								mdgriffith$elm_ui$Element$text('Use names: ')),
							onChange: author$project$Main$ChooseTable,
							options: _List_fromArray(
								[
									A2(
									mdgriffith$elm_ui$Element$Input$option,
									author$project$Main$BoyTable,
									mdgriffith$elm_ui$Element$text('Boys')),
									A2(
									mdgriffith$elm_ui$Element$Input$option,
									author$project$Main$GirlTable,
									mdgriffith$elm_ui$Element$text('Girls')),
									A2(
									mdgriffith$elm_ui$Element$Input$option,
									author$project$Main$BothTable,
									mdgriffith$elm_ui$Element$text('Both'))
								]),
							selected: elm$core$Maybe$Just(model.completeWhich)
						})
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						author$project$Main$idAttribute(author$project$Main$textAreaId)
					]),
				{
					label: mdgriffith$elm_ui$Element$Input$labelHidden('Text'),
					onChange: author$project$Main$TextChanged,
				...
				_List_fromArray(
					[
						function () {
						var _n0 = model.complete;
						if (_n0 === '') {
							return mdgriffith$elm_ui$Element$text('Not completing.');
						} else {
							var complete = _n0;
							return mdgriffith$elm_ui$Element$text(
								_Utils_ap(
									...
									A3(
										...
										',',
										', ',
										author$project$Main$stringListToString(model.completions))));
						}
					}()
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						elm$core$String$fromInt(
							elm$core$List$length(model.names.boys)) + ' boy\'s names.'),
						mdgriffith$elm_ui$Element$text(
						elm$core$String$fromInt(
							elm$core$List$length(model.names.girls)) + ' girl\'s names.')
					])),
				A2(
				mdgriffith$elm_ui$Element$row,
				_List_Nil,
				_List_fromArray(
					[
						...
						{
							label: mdgriffith$elm_ui$Element$text('billstclair/elm-id-search'),
							url: author$project$Main$packageUrl
						})
					]))
			]));
};
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						billstclair$elm_custom_element$CustomElement$TextAreaTracker$textAreaId(author$project$Main$textAreaId),
						billstclair$elm_custom_element$CustomElement$TextAreaTracker$triggerSelection(model.triggerSelection),
						billstclair$elm_custom_element$CustomElement$TextAreaTracker$onSelection(author$project$Main$OnSelection)
					]),
				_List_Nil)
			]),
