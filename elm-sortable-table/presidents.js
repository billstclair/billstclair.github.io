...
var author$project$Main$init = function (people) {
	var model = {
		people: people,
		query: '',
...
var author$project$Table$config = function (_n0) {
	var toId = _n0.toId;
	var toMsg = _n0.toMsg;
...
var author$project$Main$config = author$project$Table$config(
	{
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_Nil),
				A3(author$project$Table$view, author$project$Main$config, tableState, acceptablePeople)
			]));
};
...
var author$project$Main$main = elm$browser$Browser$element(
	{
		init: function (_n0) {
			return author$project$Main$init(author$project$Main$presidents);
		},
