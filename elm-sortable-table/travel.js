...
var author$project$Main$hour = 60;
var author$project$Main$minute = 1;
var author$project$Main$missionSights = _List_fromArray(
	[
		A5(author$project$Main$Sight, 'Eat a Burrito', 30 * author$project$Main$minute, 7, 4.6, false),
		A5(author$project$Main$Sight, 'Buy drugs in Dolores park', author$project$Main$hour, 20, 4.8, false),
		A5(author$project$Main$Sight, 'Armory Tour', 1.5 * author$project$Main$hour, 27, 4.5, false),
		A5(author$project$Main$Sight, 'Tartine Bakery', author$project$Main$hour, 10, 4.1, false),
		A5(author$project$Main$Sight, 'Have Brunch', 2 * author$project$Main$hour, 25, 4.2, false),
		A5(author$project$Main$Sight, 'Get catcalled at BART', 5 * author$project$Main$minute, 0, 1.6, false),
		A5(author$project$Main$Sight, 'Buy a painting at \"Stuff\"', 45 * author$project$Main$minute, 400, 4.7, false),
		A5(author$project$Main$Sight, 'McDonalds at 24th', 20 * author$project$Main$minute, 5, 2.8, false)
	]);
...
var author$project$Main$checkboxColumn = author$project$Table$veryCustomColumn(
	{name: '', sorter: author$project$Table$unsortable, viewData: author$project$Main$viewCheckbox});
var author$project$Main$inHours = function (time) {
	return time / 60;
};
var author$project$Main$inMinutes = function (time) {
	return time;
};
var elm$core$Basics$round = _Basics_round;
var author$project$Main$timeToString = function (time) {
	var minutes = function () {
		var _n1 = elm$core$Basics$round(
			author$project$Main$inMinutes(time)) % 60;
		switch (_n1) {
			case 0:
				return '';
			case 1:
	...
	var hours = function () {
		var _n0 = elm$core$Basics$floor(
			author$project$Main$inHours(time));
		switch (_n0) {
			case 0:
				return '';
			case 1:
...
var author$project$Table$customColumn = function (_n0) {
	var name = _n0.name;
...
var author$project$Table$customConfig = function (_n0) {
	var toId = _n0.toId;
	var toMsg = _n0.toMsg;
...
var author$project$Table$simpleRowAttrs = function (_n0) {
	return _List_Nil;
};
...
var author$project$Table$simpleTheadHelp = function (_n0) {
	var name = _n0.a;
	var status = _n0.b;
	var click = _n0.c;
...
var author$project$Main$config = author$project$Table$customConfig(
	{
...
var author$project$Table$sort = F3(
	function (_n0, columnData, data) {
		...
		var _n1 = A2(author$project$Table$findSorter, selectedColumn, columnData);
		if (_n1.$ === 'Nothing') {
			return data;
		} else {
			var sorter = _n1.a;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A3(author$project$Table$view, author$project$Main$config, tableState, sights)
			]));
};
...
var author$project$Main$main = elm$browser$Browser$element(
	{
		init: function (_n0) {
			return author$project$Main$init(author$project$Main$missionSights);
		},
