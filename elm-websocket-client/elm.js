...
var author$project$PortFunnel$WebSocket$State = function (a) {
	return {$: 'State', a: a};
};
...
var author$project$PortFunnel$WebSocket$KeyBufferedAmount = F2(
	function (key, bufferedAmount) {
		return {bufferedAmount: bufferedAmount, key: key};
	});
var author$project$PortFunnel$WebSocket$KeyDescription = F2(
	function (key, description) {
		return {description: description, key: key};
	});
var author$project$PortFunnel$WebSocket$KeyMessage = F2(
	function (key, message) {
		return {key: key, message: message};
	});
var author$project$PortFunnel$WebSocket$KeyReason = F2(
	function (key, reason) {
		return {key: key, reason: reason};
	});
var author$project$PortFunnel$WebSocket$KeyUrl = F2(
	function (key, url) {
		return {key: key, url: url};
	});
var author$project$PortFunnel$WebSocket$KeyUrlKeepAlive = F3(
	function (key, url, keepAlive) {
		return {keepAlive: keepAlive, key: key, url: url};
	});
var author$project$PortFunnel$WebSocket$MillisId = F2(
	function (millis, id) {
		return {id: id, millis: millis};
	});
var author$project$PortFunnel$WebSocket$valueDecode = F2(
...
var author$project$PortFunnel$WebSocket$InternalMessage$PIBytesQueued = function (a) {
	return {$: 'PIBytesQueued', a: a};
};
var author$project$PortFunnel$WebSocket$InternalMessage$PIClosed = function (a) {
	return {$: 'PIClosed', a: a};
};
var author$project$PortFunnel$WebSocket$InternalMessage$PIClosedRecord = F5(
...
var author$project$PortFunnel$WebSocket$InternalMessage$PIConnected = function (a) {
	return {$: 'PIConnected', a: a};
};
var author$project$PortFunnel$WebSocket$InternalMessage$PIDelayed = function (a) {
	return {$: 'PIDelayed', a: a};
};
var author$project$PortFunnel$WebSocket$InternalMessage$PIError = function (a) {
	return {$: 'PIError', a: a};
};
var author$project$PortFunnel$WebSocket$InternalMessage$PIErrorRecord = F5(
	function (key, code, description, name, message) {
		return {code: code, description: description, key: key, message: message, name: name};
	});
var author$project$PortFunnel$WebSocket$InternalMessage$PIMessageReceived = function (a) {
	return {$: 'PIMessageReceived', a: a};
};
var author$project$PortFunnel$WebSocket$InternalMessage$POBytesQueued = function (a) {
	return {$: 'POBytesQueued', a: a};
};
var author$project$PortFunnel$WebSocket$InternalMessage$POClose = function (a) {
	return {$: 'POClose', a: a};
};
var author$project$PortFunnel$WebSocket$InternalMessage$PODelay = function (a) {
	return {$: 'PODelay', a: a};
};
var author$project$PortFunnel$WebSocket$InternalMessage$POOpen = function (a) {
	return {$: 'POOpen', a: a};
};
var author$project$PortFunnel$WebSocket$InternalMessage$POSend = function (a) {
	return {$: 'POSend', a: a};
};
var author$project$PortFunnel$WebSocket$InternalMessage$PWillClose = function (a) {
	return {$: 'PWillClose', a: a};
};
var author$project$PortFunnel$WebSocket$InternalMessage$PWillOpen = function (a) {
	return {$: 'PWillOpen', a: a};
};
var author$project$PortFunnel$WebSocket$InternalMessage$PWillSend = function (a) {
	return {$: 'PWillSend', a: a};
};
var author$project$PortFunnel$WebSocket$InternalMessage$Startup = {$: 'Startup'};
...
var author$project$PortFunnel$WebSocket$decode = function (_n0) {
	var tag = _n0.tag;
	var args = _n0.args;
	switch (tag) {
		case 'startup':
			return elm$core$Result$Ok(author$project$PortFunnel$WebSocket$InternalMessage$Startup);
		case 'open':
			return A2(
				author$project$PortFunnel$WebSocket$valueDecode,
				args,
				A2(
					elm$json$Json$Decode$map,
					author$project$PortFunnel$WebSocket$InternalMessage$POOpen,
					A3(
						...
						A3(
							...
							'key',
							elm$json$Json$Decode$string,
							elm$json$Json$Decode$succeed(author$project$PortFunnel$WebSocket$KeyUrl)))));
		case 'send':
			return A2(
				author$project$PortFunnel$WebSocket$valueDecode,
				args,
				A2(
					elm$json$Json$Decode$map,
					author$project$PortFunnel$WebSocket$InternalMessage$POSend,
					A3(
						NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
						'message',
						elm$json$Json$Decode$string,
						A3(
							...
							'key',
							elm$json$Json$Decode$string,
							elm$json$Json$Decode$succeed(author$project$PortFunnel$WebSocket$KeyMessage)))));
		case 'close':
			return A2(
				author$project$PortFunnel$WebSocket$valueDecode,
				args,
				A2(
					elm$json$Json$Decode$map,
					author$project$PortFunnel$WebSocket$InternalMessage$POClose,
					A3(
						NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
						'reason',
						elm$json$Json$Decode$string,
						A3(
							...
							'key',
							elm$json$Json$Decode$string,
							elm$json$Json$Decode$succeed(author$project$PortFunnel$WebSocket$KeyReason)))));
		case 'getBytesQueued':
			return A2(
				author$project$PortFunnel$WebSocket$valueDecode,
				args,
				A2(
					elm$json$Json$Decode$map,
					author$project$PortFunnel$WebSocket$InternalMessage$POBytesQueued,
					A3(
						NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
						'key',
						elm$json$Json$Decode$string,
		...
		case 'delay':
			return A2(
				...
				A2(
					elm$json$Json$Decode$map,
					author$project$PortFunnel$WebSocket$InternalMessage$PODelay,
					A3(
						NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
						'id',
						elm$json$Json$Decode$string,
						A3(
							...
							elm$json$Json$Decode$succeed(author$project$PortFunnel$WebSocket$MillisId)))));
		case 'willopen':
			return A2(
				author$project$PortFunnel$WebSocket$valueDecode,
				args,
				A2(
					elm$json$Json$Decode$map,
					author$project$PortFunnel$WebSocket$InternalMessage$PWillOpen,
					A3(
						NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
						'keepAlive',
						...
						A3(
							...
							A3(
								...
								'key',
								elm$json$Json$Decode$string,
								elm$json$Json$Decode$succeed(author$project$PortFunnel$WebSocket$KeyUrlKeepAlive))))));
		case 'willsend':
			return A2(
				author$project$PortFunnel$WebSocket$valueDecode,
				args,
				A2(
					elm$json$Json$Decode$map,
					author$project$PortFunnel$WebSocket$InternalMessage$PWillSend,
					A3(
						NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
						'message',
						elm$json$Json$Decode$string,
		...
		case 'willclose':
			return A2(
				...
				A2(
					elm$json$Json$Decode$map,
					author$project$PortFunnel$WebSocket$InternalMessage$PWillClose,
					A3(
						NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
						'reason',
						elm$json$Json$Decode$string,
		...
		case 'connected':
			return A2(
				...
				A2(
					elm$json$Json$Decode$map,
					author$project$PortFunnel$WebSocket$InternalMessage$PIConnected,
					A3(
						NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
						'description',
						elm$json$Json$Decode$string,
						A3(
							...
							'key',
							elm$json$Json$Decode$string,
							elm$json$Json$Decode$succeed(author$project$PortFunnel$WebSocket$KeyDescription)))));
		case 'messageReceived':
			return A2(
				...
				A2(
					elm$json$Json$Decode$map,
					author$project$PortFunnel$WebSocket$InternalMessage$PIMessageReceived,
					A3(
						NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
						'message',
						elm$json$Json$Decode$string,
		...
		case 'closed':
			return A2(
				...
				A2(
					elm$json$Json$Decode$map,
					author$project$PortFunnel$WebSocket$InternalMessage$PIClosed,
					A3(
						NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
						'wasClean',
						elm$json$Json$Decode$bool,
							...
							A3(
								...
								A3(
									...
									A3(
										...
										'key',
										elm$json$Json$Decode$string,
										elm$json$Json$Decode$succeed(author$project$PortFunnel$WebSocket$InternalMessage$PIClosedRecord))))))));
		case 'bytesQueued':
			return A2(
				author$project$PortFunnel$WebSocket$valueDecode,
				args,
				A2(
					elm$json$Json$Decode$map,
					author$project$PortFunnel$WebSocket$InternalMessage$PIBytesQueued,
					A3(
						NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
						'bufferedAmount',
						elm$json$Json$Decode$int,
						A3(
							...
							'key',
							elm$json$Json$Decode$string,
							elm$json$Json$Decode$succeed(author$project$PortFunnel$WebSocket$KeyBufferedAmount)))));
		case 'delayed':
			return A2(
				author$project$PortFunnel$WebSocket$valueDecode,
				args,
				A2(
					elm$json$Json$Decode$map,
					author$project$PortFunnel$WebSocket$InternalMessage$PIDelayed,
					A3(
						NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
						'id',
						elm$json$Json$Decode$string,
		...
		case 'error':
			return A2(
				...
				A2(
					elm$json$Json$Decode$map,
					author$project$PortFunnel$WebSocket$InternalMessage$PIError,
					A4(
...
var author$project$PortFunnel$WebSocket$ClosedResponse = function (a) {
	return {$: 'ClosedResponse', a: a};
};
var author$project$PortFunnel$WebSocket$ClosingPhase = {$: 'ClosingPhase'};
var author$project$PortFunnel$WebSocket$CmdResponse = function (a) {
	return {$: 'CmdResponse', a: a};
};
var author$project$PortFunnel$WebSocket$ConnectedPhase = {$: 'ConnectedPhase'};
var author$project$PortFunnel$WebSocket$ConnectedResponse = function (a) {
	return {$: 'ConnectedResponse', a: a};
};
var author$project$PortFunnel$WebSocket$ConnectingPhase = {$: 'ConnectingPhase'};
var author$project$PortFunnel$WebSocket$ErrorResponse = function (a) {
	return {$: 'ErrorResponse', a: a};
};
var author$project$PortFunnel$WebSocket$InvalidMessageError = function (a) {
	return {$: 'InvalidMessageError', a: a};
};
var author$project$PortFunnel$WebSocket$LowLevelError = function (a) {
	return {$: 'LowLevelError', a: a};
};
var author$project$PortFunnel$WebSocket$MessageReceivedResponse = function (a) {
...
var author$project$PortFunnel$WebSocket$UnexpectedMessageError = function (a) {
	return {$: 'UnexpectedMessageError', a: a};
};
var author$project$PortFunnel$WebSocket$UnknownClosure = {$: 'UnknownClosure'};
var author$project$PortFunnel$WebSocket$BadGatewayClosure = {$: 'BadGatewayClosure'};
var author$project$PortFunnel$WebSocket$GoingAwayClosure = {$: 'GoingAwayClosure'};
var author$project$PortFunnel$WebSocket$InternalErrorClosure = {$: 'InternalErrorClosure'};
var author$project$PortFunnel$WebSocket$InvalidFramePayloadDataClosure = {$: 'InvalidFramePayloadDataClosure'};
var author$project$PortFunnel$WebSocket$MessageTooBigClosure = {$: 'MessageTooBigClosure'};
var author$project$PortFunnel$WebSocket$MissingExtensionClosure = {$: 'MissingExtensionClosure'};
var author$project$PortFunnel$WebSocket$NoStatusRecvdClosure = {$: 'NoStatusRecvdClosure'};
var author$project$PortFunnel$WebSocket$NormalClosure = {$: 'NormalClosure'};
var author$project$PortFunnel$WebSocket$PolicyViolationClosure = {$: 'PolicyViolationClosure'};
var author$project$PortFunnel$WebSocket$ProtocolErrorClosure = {$: 'ProtocolErrorClosure'};
var author$project$PortFunnel$WebSocket$ServiceRestartClosure = {$: 'ServiceRestartClosure'};
var author$project$PortFunnel$WebSocket$TLSHandshakeClosure = {$: 'TLSHandshakeClosure'};
var author$project$PortFunnel$WebSocket$TimedOutOnReconnect = {$: 'TimedOutOnReconnect'};
var author$project$PortFunnel$WebSocket$TryAgainLaterClosure = {$: 'TryAgainLaterClosure'};
var author$project$PortFunnel$WebSocket$UnsupportedDataClosure = {$: 'UnsupportedDataClosure'};
var author$project$PortFunnel$WebSocket$closurePairs = _List_fromArray(
	[
		_Utils_Tuple2(1000, author$project$PortFunnel$WebSocket$NormalClosure),
		_Utils_Tuple2(1001, author$project$PortFunnel$WebSocket$GoingAwayClosure),
		_Utils_Tuple2(1002, author$project$PortFunnel$WebSocket$ProtocolErrorClosure),
		_Utils_Tuple2(1003, author$project$PortFunnel$WebSocket$UnsupportedDataClosure),
		_Utils_Tuple2(1005, author$project$PortFunnel$WebSocket$NoStatusRecvdClosure),
		_Utils_Tuple2(1006, author$project$PortFunnel$WebSocket$AbnormalClosure),
		_Utils_Tuple2(1007, author$project$PortFunnel$WebSocket$InvalidFramePayloadDataClosure),
		_Utils_Tuple2(1008, author$project$PortFunnel$WebSocket$PolicyViolationClosure),
		_Utils_Tuple2(1009, author$project$PortFunnel$WebSocket$MessageTooBigClosure),
		_Utils_Tuple2(1010, author$project$PortFunnel$WebSocket$MissingExtensionClosure),
		_Utils_Tuple2(1011, author$project$PortFunnel$WebSocket$InternalErrorClosure),
		_Utils_Tuple2(1012, author$project$PortFunnel$WebSocket$ServiceRestartClosure),
		_Utils_Tuple2(1013, author$project$PortFunnel$WebSocket$TryAgainLaterClosure),
		_Utils_Tuple2(1014, author$project$PortFunnel$WebSocket$BadGatewayClosure),
		_Utils_Tuple2(1015, author$project$PortFunnel$WebSocket$TLSHandshakeClosure),
		_Utils_Tuple2(4000, author$project$PortFunnel$WebSocket$TimedOutOnReconnect)
	]);
...
var author$project$PortFunnel$WebSocket$closureDict = elm$core$Dict$fromList(author$project$PortFunnel$WebSocket$closurePairs);
...
var author$project$PortFunnel$WebSocket$closedCode = function (code) {
	return A2(
		elm$core$Maybe$withDefault,
		author$project$PortFunnel$WebSocket$UnknownClosure,
		A2(elm$core$Dict$get, code, author$project$PortFunnel$WebSocket$closureDict));
};
...
var author$project$PortFunnel$WebSocket$closedCodeNumber = function (code) {
	var _n0 = A2(
		...
		author$project$PortFunnel$WebSocket$closurePairs);
	if (_n0.$ === 'Just') {
		var _n2 = _n0.a;
		var _int = _n2.a;
		return _int;
...
var author$project$PortFunnel$WebSocket$IdlePhase = {$: 'IdlePhase'};
var author$project$PortFunnel$WebSocket$emptySocketState = {backoff: 0, continuationId: elm$core$Maybe$Nothing, keepAlive: false, phase: author$project$PortFunnel$WebSocket$IdlePhase, url: ''};
var author$project$PortFunnel$WebSocket$getSocketState = F2(
	function (key, state) {
		return A2(
			elm$core$Maybe$withDefault,
			author$project$PortFunnel$WebSocket$emptySocketState,
...
var author$project$PortFunnel$WebSocket$doClose = F3(
	function (state, key, reason) {
		var socketState = A2(author$project$PortFunnel$WebSocket$getSocketState, key, state);
		return (!_Utils_eq(socketState.phase, author$project$PortFunnel$WebSocket$ConnectedPhase)) ? _Utils_Tuple2(
			...
			author$project$PortFunnel$WebSocket$NoResponse) : _Utils_Tuple2(
			author$project$PortFunnel$WebSocket$State(
				_Utils_update(
					state,
					{
						socketStates: A3(
							...
							_Utils_update(
								socketState,
								{phase: author$project$PortFunnel$WebSocket$ClosingPhase}),
							state.socketStates)
					})),
			author$project$PortFunnel$WebSocket$CmdResponse(
				author$project$PortFunnel$WebSocket$InternalMessage$POClose(
					{key: key, reason: 'user request'})));
	});
var author$project$PortFunnel$WebSocket$SocketAlreadyOpenError = function (a) {
	return {$: 'SocketAlreadyOpenError', a: a};
};
var author$project$PortFunnel$WebSocket$SocketClosingError = function (a) {
	return {$: 'SocketClosingError', a: a};
};
var author$project$PortFunnel$WebSocket$SocketConnectingError = function (a) {
	return {$: 'SocketConnectingError', a: a};
};
var author$project$PortFunnel$WebSocket$checkUsedSocket = F2(
	function (state, key) {
		var socketState = A2(author$project$PortFunnel$WebSocket$getSocketState, key, state);
			...
			case 'ConnectedPhase':
				return elm$core$Result$Err(
					_Utils_Tuple2(
						...
						author$project$PortFunnel$WebSocket$ErrorResponse(
							author$project$PortFunnel$WebSocket$SocketAlreadyOpenError(key))));
			case 'ConnectingPhase':
				return elm$core$Result$Err(
					_Utils_Tuple2(
						author$project$PortFunnel$WebSocket$State(state),
						author$project$PortFunnel$WebSocket$ErrorResponse(
							author$project$PortFunnel$WebSocket$SocketConnectingError(key))));
			default:
				return elm$core$Result$Err(
					_Utils_Tuple2(
						author$project$PortFunnel$WebSocket$State(state),
						author$project$PortFunnel$WebSocket$ErrorResponse(
							author$project$PortFunnel$WebSocket$SocketClosingError(key))));
		}
	});
var author$project$PortFunnel$WebSocket$doOpen = F4(
	function (state, key, url, keepAlive) {
		var _n0 = A2(author$project$PortFunnel$WebSocket$checkUsedSocket, state, key);
		if (_n0.$ === 'Err') {
			var res = _n0.a;
			return res;
		} else {
					...
					_Utils_update(
						state,
						{
							socketStates: A3(
								...
								_Utils_update(
									socketState,
									{keepAlive: keepAlive, phase: author$project$PortFunnel$WebSocket$ConnectingPhase, url: url}),
								state.socketStates)
						})),
				author$project$PortFunnel$WebSocket$CmdResponse(
					author$project$PortFunnel$WebSocket$InternalMessage$POOpen(
...
var author$project$PortFunnel$WebSocket$SocketNotOpenError = function (a) {
	return {$: 'SocketNotOpenError', a: a};
};
var author$project$PortFunnel$WebSocket$queueSend = F3(
...
var author$project$PortFunnel$WebSocket$doSend = F3(
	function (state, key, message) {
		var socketState = A2(author$project$PortFunnel$WebSocket$getSocketState, key, state);
		return (!_Utils_eq(socketState.phase, author$project$PortFunnel$WebSocket$ConnectedPhase)) ? ((!socketState.backoff) ? _Utils_Tuple2(
			author$project$PortFunnel$WebSocket$State(state),
			author$project$PortFunnel$WebSocket$ErrorResponse(
				author$project$PortFunnel$WebSocket$SocketNotOpenError(key))) : A3(author$project$PortFunnel$WebSocket$queueSend, state, key, message)) : (_Utils_eq(
			A2(elm$core$Dict$get, key, state.queues),
			elm$core$Maybe$Nothing) ? _Utils_Tuple2(
			author$project$PortFunnel$WebSocket$State(state),
			author$project$PortFunnel$WebSocket$CmdResponse(
				author$project$PortFunnel$WebSocket$InternalMessage$POSend(
					{key: key, message: message}))) : A3(author$project$PortFunnel$WebSocket$queueSend, state, key, message));
	});
var author$project$PortFunnel$WebSocket$getContinuation = F2(
	function (id, state) {
...
var author$project$PortFunnel$WebSocket$RetryConnection = {$: 'RetryConnection'};
var author$project$PortFunnel$WebSocket$allocateContinuation = F3(
	function (key, kind, state) {
		...
		var _n0 = function () {
			...
			if (_n1.$ === 'Nothing') {
				return _Utils_Tuple2(
					state.continuations,
					A2(author$project$PortFunnel$WebSocket$getSocketState, key, state));
			} else {
				var sockState = _n1.a;
...
var author$project$PortFunnel$WebSocket$backoffMillis = function (backoff) {
	return 10 * A2(elm$core$Basics$pow, 2, backoff);
};
var author$project$PortFunnel$WebSocket$maxBackoff = 10;
var author$project$PortFunnel$WebSocket$unexpectedClose = F2(
	function (state, _n0) {
		var key = _n0.key;
		var code = _n0.code;
...
var author$project$PortFunnel$WebSocket$handleUnexpectedClose = F2(
	function (state, closedRecord) {
		var key = closedRecord.key;
		var socketState = A2(author$project$PortFunnel$WebSocket$getSocketState, key, state);
		var backoff = 1 + socketState.backoff;
		if ((_Utils_cmp(backoff, author$project$PortFunnel$WebSocket$maxBackoff) > 0) || (((backoff === 1) && (!_Utils_eq(socketState.phase, author$project$PortFunnel$WebSocket$ConnectedPhase))) || (closedRecord.bytesQueued > 0))) {
			return A2(
				author$project$PortFunnel$WebSocket$unexpectedClose,
				state,
				_Utils_update(
					closedRecord,
					{
						code: (_Utils_cmp(backoff, author$project$PortFunnel$WebSocket$maxBackoff) > 0) ? author$project$PortFunnel$WebSocket$closedCodeNumber(author$project$PortFunnel$WebSocket$TimedOutOnReconnect) : closedRecord.code
					}));
		} else {
			if (socketState.url === '') {
				return A2(author$project$PortFunnel$WebSocket$unexpectedClose, state, closedRecord);
			} else {
				var _n0 = A3(author$project$PortFunnel$WebSocket$allocateContinuation, key, author$project$PortFunnel$WebSocket$RetryConnection, state);
				var id = _n0.a;
				var state2 = _n0.b;
				var delay = author$project$PortFunnel$WebSocket$InternalMessage$PODelay(
					{
						id: id,
						millis: author$project$PortFunnel$WebSocket$backoffMillis(backoff)
					});
				return _Utils_Tuple2(
					author$project$PortFunnel$WebSocket$State(
						_Utils_update(
					...
					author$project$PortFunnel$WebSocket$CmdResponse(delay));
			}
		}
	});
var author$project$PortFunnel$WebSocket$DrainOutputQueue = {$: 'DrainOutputQueue'};
	...
	function (state, key) {
		...
		if (_n0.$ === 'Nothing') {
			...
			if (!_n0.a.b) {
				...
				var message = _n1.a;
				var tail = _n1.b;
				var posend = author$project$PortFunnel$WebSocket$InternalMessage$POSend(
					{key: key, message: message});
				var _n2 = A3(author$project$PortFunnel$WebSocket$allocateContinuation, key, author$project$PortFunnel$WebSocket$DrainOutputQueue, state);
				var id = _n2.a;
				var state2 = _n2.b;
...
var author$project$PortFunnel$WebSocket$process = F2(
	function (mess, unboxed) {
		...
		switch (mess.$) {
			...
			case 'PWillOpen':
				...
				var url = mess.a.url;
				var keepAlive = mess.a.keepAlive;
				return A4(author$project$PortFunnel$WebSocket$doOpen, state, key, url, keepAlive);
			case 'PWillSend':
				var key = mess.a.key;
				var message = mess.a.message;
				return A3(author$project$PortFunnel$WebSocket$doSend, state, key, message);
			case 'PWillClose':
				var key = mess.a.key;
				var reason = mess.a.reason;
				return A3(author$project$PortFunnel$WebSocket$doClose, state, key, reason);
			case 'PIConnected':
				var key = mess.a.key;
				var description = mess.a.description;
				var socketState = A2(author$project$PortFunnel$WebSocket$getSocketState, key, state);
				if (!_Utils_eq(socketState.phase, author$project$PortFunnel$WebSocket$ConnectingPhase)) {
					return _Utils_Tuple2(
						author$project$PortFunnel$WebSocket$State(state),
						author$project$PortFunnel$WebSocket$ErrorResponse(
							author$project$PortFunnel$WebSocket$UnexpectedConnectedError(
					...
					var newState = _Utils_update(
						state,
						{
							socketStates: A3(
								...
								_Utils_update(
									socketState,
									{backoff: 0, phase: author$project$PortFunnel$WebSocket$ConnectedPhase}),
								state.socketStates)
						});
			...
			case 'PIMessageReceived':
				...
				return (!_Utils_eq(socketState.phase, author$project$PortFunnel$WebSocket$ConnectedPhase)) ? _Utils_Tuple2(
					author$project$PortFunnel$WebSocket$State(state),
					author$project$PortFunnel$WebSocket$ErrorResponse(
						author$project$PortFunnel$WebSocket$UnexpectedMessageError(
							{key: key, message: message}))) : _Utils_Tuple2(
					author$project$PortFunnel$WebSocket$State(state),
					socketState.keepAlive ? author$project$PortFunnel$WebSocket$NoResponse : author$project$PortFunnel$WebSocket$MessageReceivedResponse(
						{key: key, message: message}));
			case 'PIClosed':
			...
			case 'PIDelayed':
				var id = mess.a.id;
				var _n1 = A2(author$project$PortFunnel$WebSocket$getContinuation, id, state);
				if (_n1.$ === 'Nothing') {
					return _Utils_Tuple2(
						author$project$PortFunnel$WebSocket$State(state),
						author$project$PortFunnel$WebSocket$NoResponse);
					...
					if (kind.$ === 'DrainOutputQueue') {
						...
						return (url !== '') ? _Utils_Tuple2(
								...
								_Utils_update(
									state2,
									{
										socketStates: A3(
											...
											_Utils_update(
												socketState,
												{phase: author$project$PortFunnel$WebSocket$ConnectingPhase}),
											state.socketStates)
									})),
							author$project$PortFunnel$WebSocket$CmdResponse(
								author$project$PortFunnel$WebSocket$InternalMessage$POOpen(
							...
							{
								bytesQueued: 0,
								code: author$project$PortFunnel$WebSocket$closedCodeNumber(author$project$PortFunnel$WebSocket$AbnormalClosure),
								key: key,
			...
			case 'PIError':
				...
				return _Utils_Tuple2(
					author$project$PortFunnel$WebSocket$State(state),
					author$project$PortFunnel$WebSocket$ErrorResponse(
						author$project$PortFunnel$WebSocket$LowLevelError(
							{code: code, description: description, key: key, message: message, name: name})));
			default:
				return _Utils_Tuple2(
					author$project$PortFunnel$WebSocket$State(state),
					author$project$PortFunnel$WebSocket$ErrorResponse(
						author$project$PortFunnel$WebSocket$InvalidMessageError(
							{message: mess})));
		}
	});
...
var author$project$PortFunnel$WebSocket$simulator = function (mess) {
	switch (mess.$) {
		...
		case 'PWillOpen':
			var record = mess.a;
			return elm$core$Maybe$Just(
				author$project$PortFunnel$WebSocket$InternalMessage$PWillOpen(record));
		case 'POOpen':
			var key = mess.a.key;
			return elm$core$Maybe$Just(
				author$project$PortFunnel$WebSocket$InternalMessage$PIConnected(
		...
		case 'PWillSend':
			var record = mess.a;
			return elm$core$Maybe$Just(
				author$project$PortFunnel$WebSocket$InternalMessage$PWillSend(record));
		case 'POSend':
			var key = mess.a.key;
			var message = mess.a.message;
			return elm$core$Maybe$Just(
		...
		case 'PWillClose':
			var record = mess.a;
			return elm$core$Maybe$Just(
				author$project$PortFunnel$WebSocket$InternalMessage$PWillClose(record));
		case 'POClose':
			var key = mess.a.key;
			var reason = mess.a.reason;
			return elm$core$Maybe$Just(
				author$project$PortFunnel$WebSocket$InternalMessage$PIClosed(
					{
						bytesQueued: 0,
						code: author$project$PortFunnel$WebSocket$closedCodeNumber(author$project$PortFunnel$WebSocket$NormalClosure),
						key: key,
		...
		case 'PODelay':
			...
			return elm$core$Maybe$Just(
				author$project$PortFunnel$WebSocket$InternalMessage$PIDelayed(
					{id: id}));
		default:
			var name = author$project$PortFunnel$WebSocket$encode(mess).tag;
			return elm$core$Maybe$Just(
				author$project$PortFunnel$WebSocket$InternalMessage$PIError(
					{
...
var author$project$PortFunnel$WebSocket$send = billstclair$elm_port_funnel$PortFunnel$sendMessage(author$project$PortFunnel$WebSocket$moduleDesc);
...
var author$project$PortFunnel$WebSocket$makeOpenWithKey = F2(
	function (key, url) {
		return author$project$PortFunnel$WebSocket$InternalMessage$PWillOpen(
			{keepAlive: false, key: key, url: url});
	});
var author$project$PortFunnel$WebSocket$makeSend = F2(
	function (key, message) {
		return author$project$PortFunnel$WebSocket$InternalMessage$PWillSend(
			{key: key, message: message});
	});
...
var author$project$PortFunnel$WebSocket$setAutoReopen = F3(
	function (key, autoReopen, _n0) {
		...
		return author$project$PortFunnel$WebSocket$State(
			_Utils_update(
				state,
				{noAutoReopenKeys: keys}));
	});
var author$project$PortFunnel$WebSocket$willAutoReopen = F2(
	function (key, _n0) {
		var state = _n0.a;
			...
			case 'Connect':
				return A2(
					...
					A2(
						...
						model,
						A2(author$project$PortFunnel$WebSocket$makeOpenWithKey, model.key, model.url)),
					_Utils_update(
						model,
						{
							log: A2(
			...
			case 'Send':
				return A2(
					...
					A2(
						author$project$Main$send,
						model,
						A2(author$project$PortFunnel$WebSocket$makeSend, model.key, model.send)),
					_Utils_update(
						model,
						{
			...
			case 'Close':
				return A2(
					...
					A2(
						author$project$Main$send,
						model,
						author$project$PortFunnel$WebSocket$makeClose(model.key)),
					_Utils_update(
						model,
						{
...
var author$project$PortFunnel$WebSocket$isConnected = F2(
	function (key, _n0) {
		var state = _n0.a;
		return !_Utils_eq(
			A2(elm$core$Dict$get, key, state.socketStates),
