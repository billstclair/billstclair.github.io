...
var author$project$WebSocketClient$Config = function (a) {
	return {$: 'Config', a: a};
};
var author$project$WebSocketClient$ConfigRecord = F2(
	function (sendPort, simulator) {
		return {sendPort: sendPort, simulator: simulator};
	});
...
var author$project$WebSocketClient$makeSimulatorConfig = function (simulator) {
	return author$project$WebSocketClient$Config(
		A2(
			author$project$WebSocketClient$ConfigRecord,
			function (_n0) {
				return elm$core$Platform$Cmd$none;
			},
			elm$core$Maybe$Just(simulator)));
};
var author$project$Main$simulatorConfig = author$project$WebSocketClient$makeSimulatorConfig(elm$core$Maybe$Just);
...
var author$project$WebSocketClient$makeState = function (config) {
	return author$project$WebSocketClient$State(
		{config: config, continuationCounter: 0, continuations: elm$core$Dict$empty, queues: elm$core$Dict$empty, socketStates: elm$core$Dict$empty});
};
	...
	return _Utils_Tuple2(
		{
			...
			log: _List_Nil,
			send: 'Hello World!',
			state: author$project$WebSocketClient$makeState(author$project$Main$simulatorConfig),
...
var author$project$Main$webSocketClientSub = _Platform_incomingPort('webSocketClientSub', elm$json$Json$Decode$value);
...
var author$project$WebSocketClient$ConnectedPhase = {$: 'ConnectedPhase'};
var author$project$WebSocketClient$ConnectedResponse = function (a) {
	return {$: 'ConnectedResponse', a: a};
};
var author$project$WebSocketClient$ConnectingPhase = {$: 'ConnectingPhase'};
var author$project$WebSocketClient$ErrorResponse = function (a) {
	return {$: 'ErrorResponse', a: a};
};
var author$project$WebSocketClient$SocketAlreadyOpenError = function (a) {
	return {$: 'SocketAlreadyOpenError', a: a};
};
var author$project$WebSocketClient$SocketClosingError = function (a) {
	return {$: 'SocketClosingError', a: a};
};
var author$project$WebSocketClient$SocketConnectingError = function (a) {
...
var author$project$WebSocketClient$getSocketState = F2(
	function (key, state) {
		return A2(
			elm$core$Maybe$withDefault,
			author$project$WebSocketClient$emptySocketState,
			A2(elm$core$Dict$get, key, state.socketStates));
	});
var author$project$WebSocketClient$checkUsedSocket = F2(
	function (state, key) {
		var socketState = A2(author$project$WebSocketClient$getSocketState, key, state);
				...
				return elm$core$Result$Err(
					_Utils_Tuple2(
						...
						author$project$WebSocketClient$ErrorResponse(
							author$project$WebSocketClient$SocketAlreadyOpenError(key))));
			case 'ConnectingPhase':
				return elm$core$Result$Err(
					_Utils_Tuple2(
						author$project$WebSocketClient$State(state),
						author$project$WebSocketClient$ErrorResponse(
							author$project$WebSocketClient$SocketConnectingError(key))));
			default:
				return elm$core$Result$Err(
					_Utils_Tuple2(
						author$project$WebSocketClient$State(state),
						author$project$WebSocketClient$ErrorResponse(
							author$project$WebSocketClient$SocketClosingError(key))));
		}
	});
var author$project$WebSocketClient$PortMessage$POOpen = function (a) {
	return {$: 'POOpen', a: a};
};
...
var author$project$WebSocketClient$PortMessage$encodeRawPortMessage = function (message) {
	var args = A2(
		elm$core$List$map,
		function (_n0) {
			var name = _n0.a;
		...
		elm$core$Dict$toList(message.args));
...
var author$project$WebSocketClient$PortMessage$RawPortMessage = F2(
	function (tag, args) {
...
var author$project$WebSocketClient$PortMessage$toRawPortMessage = function (portMessage) {
	switch (portMessage.$) {
		case 'POOpen':
			var key = portMessage.a.key;
			var url = portMessage.a.url;
			return A2(
		...
		case 'POSend':
			var key = portMessage.a.key;
			var message = portMessage.a.message;
			return A2(
				author$project$WebSocketClient$PortMessage$RawPortMessage,
				'send',
				elm$core$Dict$fromList(
		...
		case 'POClose':
			var key = portMessage.a.key;
			var reason = portMessage.a.reason;
			return A2(
				author$project$WebSocketClient$PortMessage$RawPortMessage,
				'close',
				elm$core$Dict$fromList(
...
var author$project$WebSocketClient$PortMessage$encodePortMessage = A2(elm$core$Basics$composeR, author$project$WebSocketClient$PortMessage$toRawPortMessage, author$project$WebSocketClient$PortMessage$encodeRawPortMessage);
var author$project$WebSocketClient$openWithKeyInternal = F3(
	function (_n0, key, url) {
		...
		if (_n1.$ === 'Err') {
			...
			var socketState = _n1.a;
			var po = author$project$WebSocketClient$PortMessage$POOpen(
				{key: key, url: url});
						...
						_Utils_update(
							state,
							{
								socketStates: A3(
									...
									_Utils_update(
										socketState,
										{phase: author$project$WebSocketClient$ConnectingPhase, url: url}),
									state.socketStates)
							})),
						...
						_Utils_update(
							state,
							{
								socketStates: A3(
									...
									_Utils_update(
										socketState,
										{phase: author$project$WebSocketClient$ConnectedPhase, url: url}),
									state.socketStates)
							})),
					author$project$WebSocketClient$ConnectedResponse(
						{description: 'simulated', key: key}));
			}
		}
	});
	...
	function (model, config) {
		var m = _Utils_update(
			model,
			{
				...
				key: model.url,
				state: author$project$WebSocketClient$makeState(config)
			});
		return A2(
...
var author$project$WebSocketClient$send = F4(
	function (_n0, _n1, key, message) {
		var state = _n1.a;
		var socketState = A2(author$project$WebSocketClient$getSocketState, key, state);
		if (!_Utils_eq(socketState.phase, author$project$WebSocketClient$ConnectedPhase)) {
...
var author$project$WebSocketClient$ClosingPhase = {$: 'ClosingPhase'};
...
var author$project$WebSocketClient$close = F2(
	function (_n0, key) {
		var state = _n0.a;
		var socketState = A2(author$project$WebSocketClient$getSocketState, key, state);
		if (!_Utils_eq(socketState.phase, author$project$WebSocketClient$ConnectedPhase)) {
					...
					_Utils_update(
						state,
						{
							continuations: function () {
								var _n1 = socketState.continuationId;
								if (_n1.$ === 'Nothing') {
			...
			var po = author$project$WebSocketClient$PortMessage$POClose(
			...
			if (simulator.$ === 'Nothing') {
						...
						_Utils_update(
							state,
							{
								socketStates: A3(
									...
									_Utils_update(
										socketState,
										{phase: author$project$WebSocketClient$ClosingPhase}),
									state.socketStates)
							})),
					author$project$WebSocketClient$CmdResponse(
						sendPort(
				...
				return _Utils_Tuple2(
					...
					author$project$WebSocketClient$ClosedResponse(
						{code: author$project$WebSocketClient$NormalClosure, expected: true, key: key, reason: 'simulator', wasClean: true}));
			}
		}
	});
var author$project$WebSocketClient$makeConfig = function (sendPort) {
	return author$project$WebSocketClient$Config(
...
var author$project$WebSocketClient$UnexpectedConnectedError = function (a) {
	return {$: 'UnexpectedConnectedError', a: a};
};
var author$project$WebSocketClient$UnexpectedMessageError = function (a) {
...
var author$project$WebSocketClient$InvalidFramePayloadDataClosure = {$: 'InvalidFramePayloadDataClosure'};
var author$project$WebSocketClient$MessageTooBigClosure = {$: 'MessageTooBigClosure'};
var author$project$WebSocketClient$MissingExtensionClosure = {$: 'MissingExtensionClosure'};
var author$project$WebSocketClient$NoStatusRecvdClosure = {$: 'NoStatusRecvdClosure'};
var author$project$WebSocketClient$PolicyViolationClosure = {$: 'PolicyViolationClosure'};
...
var author$project$WebSocketClient$getContinuation = F2(
	function (id, state) {
...
var author$project$WebSocketClient$RetryConnection = {$: 'RetryConnection'};
var author$project$WebSocketClient$allocateContinuation = F3(
	function (key, kind, state) {
		...
		var _n0 = function () {
			...
			if (_n1.$ === 'Nothing') {
				return _Utils_Tuple2(
					state.continuations,
					A2(author$project$WebSocketClient$getSocketState, key, state));
			} else {
				var sockState = _n1.a;
...
var author$project$WebSocketClient$handleUnexpectedClose = F2(
	function (state, closedRecord) {
		...
		if ((_Utils_cmp(backoff, author$project$WebSocketClient$maxBackoff) > 0) || (((backoff === 1) && (!_Utils_eq(socketState.phase, author$project$WebSocketClient$ConnectedPhase))) || (closedRecord.bytesQueued > 0))) {
			return A2(
			...
			if (socketState.url === '') {
				...
				var _n0 = A3(author$project$WebSocketClient$allocateContinuation, key, author$project$WebSocketClient$RetryConnection, state);
				var id = _n0.a;
				var state2 = _n0.b;
...
var author$project$WebSocketClient$DrainOutputQueue = {$: 'DrainOutputQueue'};
		...
		if (_n0.$ === 'Nothing') {
			...
			if (!_n0.a.b) {
				...
				var podelay = author$project$WebSocketClient$PortMessage$PODelay(
					{id: id, millis: 20});
				var _n3 = state.config;
				var sendPort = _n3.a.sendPort;
...
var author$project$WebSocketClient$PortMessage$InvalidMessage = {$: 'InvalidMessage'};
var author$project$WebSocketClient$PortMessage$PIBytesQueued = function (a) {
	return {$: 'PIBytesQueued', a: a};
};
var author$project$WebSocketClient$PortMessage$PIClosed = function (a) {
	return {$: 'PIClosed', a: a};
};
				...
				while (true) {
					if (!tail.b) {
						...
						if (_n1.$ === 'Nothing') {
							...
							var a = _n1.a;
							var $temp$tail = rest,
								$temp$res = A2(elm$core$List$cons, a, res);
							tail = $temp$tail;
							res = $temp$res;
							continue loop;
						}
	...
	switch (tag) {
		case 'connected':
			var _n2 = A2(
				...
				_List_fromArray(
					['key', 'description']),
				args);
			if ((((_n2.$ === 'Just') && _n2.a.b) && _n2.a.b.b) && (!_n2.a.b.b.b)) {
				var _n3 = _n2.a;
				var key = _n3.a;
				var _n4 = _n3.b;
				var description = _n4.a;
				return author$project$WebSocketClient$PortMessage$PIConnected(
		...
		case 'messageReceived':
			var _n5 = A2(
				...
				_List_fromArray(
					['key', 'message']),
				args);
			if ((((_n5.$ === 'Just') && _n5.a.b) && _n5.a.b.b) && (!_n5.a.b.b.b)) {
				var _n6 = _n5.a;
				var key = _n6.a;
				var _n7 = _n6.b;
				var message = _n7.a;
				return author$project$WebSocketClient$PortMessage$PIMessageReceived(
					{key: key, message: message});
			} else {
				return author$project$WebSocketClient$PortMessage$InvalidMessage;
			}
		case 'closed':
			var _n8 = A2(
				...
				args);
			if (((((((_n8.$ === 'Just') && _n8.a.b) && _n8.a.b.b) && _n8.a.b.b.b) && _n8.a.b.b.b.b) && _n8.a.b.b.b.b.b) && (!_n8.a.b.b.b.b.b.b)) {
				var _n9 = _n8.a;
				var key = _n9.a;
				var _n10 = _n9.b;
				var bytesQueued = _n10.a;
				var _n11 = _n10.b;
				var code = _n11.a;
				var _n12 = _n11.b;
				var reason = _n12.a;
				var _n13 = _n12.b;
				var wasClean = _n13.a;
				return author$project$WebSocketClient$PortMessage$PIClosed(
					{
						bytesQueued: A2(
							elm$core$Maybe$withDefault,
							0,
							elm$core$String$toInt(bytesQueued)),
						code: A2(
							elm$core$Maybe$withDefault,
							-1,
		...
		case 'bytesQueued':
			var _n14 = A2(
				...
				_List_fromArray(
					['key', 'bufferedAmount']),
				args);
			if ((((_n14.$ === 'Just') && _n14.a.b) && _n14.a.b.b) && (!_n14.a.b.b.b)) {
				var _n15 = _n14.a;
				var key = _n15.a;
				var _n16 = _n15.b;
				var bufferedAmountString = _n16.a;
				var _n17 = elm$core$String$toInt(bufferedAmountString);
				if (_n17.$ === 'Nothing') {
					return author$project$WebSocketClient$PortMessage$InvalidMessage;
				} else {
					var bufferedAmount = _n17.a;
					return author$project$WebSocketClient$PortMessage$PIBytesQueued(
						{bufferedAmount: bufferedAmount, key: key});
				}
			} else {
				return author$project$WebSocketClient$PortMessage$InvalidMessage;
			}
		case 'delayed':
			var _n18 = A2(
				...
				_List_fromArray(
					['id']),
				args);
			if (((_n18.$ === 'Just') && _n18.a.b) && (!_n18.a.b.b)) {
				var _n19 = _n18.a;
				var id = _n19.a;
				...
				return author$project$WebSocketClient$PortMessage$PIError(
					{
						...
						key: A2(elm$core$Dict$get, 'key', args),
						name: A2(elm$core$Dict$get, 'name', args)
					});
			} else {
				return author$project$WebSocketClient$PortMessage$InvalidMessage;
			}
...
var author$project$WebSocketClient$PortMessage$portMessageDecoder = A2(elm$json$Json$Decode$map, author$project$WebSocketClient$PortMessage$fromRawPortMessage, author$project$WebSocketClient$PortMessage$rawPortMessageDecoder);
var author$project$WebSocketClient$PortMessage$decodePortMessage = function (value) {
	return A2(author$project$WebSocketClient$PortMessage$decodeValue, author$project$WebSocketClient$PortMessage$portMessageDecoder, value);
};
var author$project$WebSocketClient$process = F2(
	function (_n0, value) {
		var state = _n0.a;
		var _n1 = author$project$WebSocketClient$PortMessage$decodePortMessage(value);
		if (_n1.$ === 'Err') {
			var errstr = _n1.a;
			return _Utils_Tuple2(
				author$project$WebSocketClient$State(state),
				author$project$WebSocketClient$ErrorResponse(
					author$project$WebSocketClient$PortDecodeError(
						{error: errstr})));
		} else {
			var pi = _n1.a;
			switch (pi.$) {
				case 'PIConnected':
					...
					var socketState = A2(author$project$WebSocketClient$getSocketState, key, state);
					if (!_Utils_eq(socketState.phase, author$project$WebSocketClient$ConnectingPhase)) {
						return _Utils_Tuple2(
							author$project$WebSocketClient$State(state),
							author$project$WebSocketClient$ErrorResponse(
						...
						var newState = _Utils_update(
							state,
							{
								socketStates: A3(
									...
									_Utils_update(
										socketState,
										{backoff: 0, phase: author$project$WebSocketClient$ConnectedPhase}),
									state.socketStates)
							});
						return (!socketState.backoff) ? _Utils_Tuple2(
				...
				case 'PIMessageReceived':
					...
					var socketState = A2(author$project$WebSocketClient$getSocketState, key, state);
					return (!_Utils_eq(socketState.phase, author$project$WebSocketClient$ConnectedPhase)) ? _Utils_Tuple2(
						author$project$WebSocketClient$State(state),
						author$project$WebSocketClient$ErrorResponse(
				...
				case 'PIClosed':
					...
					var socketStates = A2(author$project$WebSocketClient$getSocketState, key, state);
					return (!_Utils_eq(socketStates.phase, author$project$WebSocketClient$ClosingPhase)) ? A2(author$project$WebSocketClient$handleUnexpectedClose, state, closedRecord) : _Utils_Tuple2(
						author$project$WebSocketClient$State(
							_Utils_update(
								state,
								{
				...
				case 'PIBytesQueued':
					var key = pi.a.key;
					var bufferedAmount = pi.a.bufferedAmount;
					return _Utils_Tuple2(
						author$project$WebSocketClient$State(state),
						author$project$WebSocketClient$NoResponse);
				case 'PIDelayed':
					var id = pi.a.id;
					var _n3 = A2(author$project$WebSocketClient$getContinuation, id, state);
					if (_n3.$ === 'Nothing') {
						return _Utils_Tuple2(
							author$project$WebSocketClient$State(state),
							author$project$WebSocketClient$NoResponse);
						...
						if (kind.$ === 'DrainOutputQueue') {
							return A2(author$project$WebSocketClient$processQueuedMessage, state2, key);
						} else {
							var socketState = A2(author$project$WebSocketClient$getSocketState, key, state);
									...
									_Utils_update(
										state2,
										{
											socketStates: A3(
												...
												_Utils_update(
													socketState,
													{phase: author$project$WebSocketClient$IdlePhase}),
												state.socketStates)
										})),
								key,
								url) : A2(
				...
				case 'PIError':
					...
					return _Utils_Tuple2(
						author$project$WebSocketClient$State(state),
						author$project$WebSocketClient$ErrorResponse(
							author$project$WebSocketClient$LowLevelError(
								{code: code, description: description, key: key, name: name})));
				default:
					return _Utils_Tuple2(
						author$project$WebSocketClient$State(state),
						author$project$WebSocketClient$ErrorResponse(
							author$project$WebSocketClient$InvalidMessageError(
								{
									json: A2(elm$json$Json$Encode$encode, 0, value)
								})));
			}
		}
	});
		...
		switch (msg.$) {
			...
			case 'Connect':
				return A2(
					...
					author$project$WebSocketClient$makeConfig(author$project$Main$webSocketClientCmd));
			case 'Simulate':
				return A2(
					author$project$Main$connect,
					_Utils_update(
						model,
						{
							log: A2(elm$core$List$cons, 'Connecting to simulator', model.log)
						}),
					author$project$Main$simulatorConfig);
			case 'Send':
				return A2(
					author$project$Main$processResponse,
					_Utils_update(
			...
			case 'Receive':
				...
				return A2(
					author$project$Main$processResponse,
					model,
					A2(author$project$WebSocketClient$process, model.state, value));
			default:
				return A2(
					author$project$Main$processResponse,
					_Utils_update(
...
var author$project$Main$view = function (model) {
	var isConnected = !_Utils_eq(model.config, elm$core$Maybe$Nothing);
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('WebSocketClient Example')
					])),
				A2(
				elm$html$Html$p,
				_List_Nil,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Events$onClick(author$project$Main$Simulate)
									]),
								_List_fromArray(
									[
										elm$html$Html$text('Simulate')
									]))
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						author$project$Main$docp('Click \'Simulate\' to connect to a simulated echo server.' + ' This will work in \'elm reactor\'.'),
